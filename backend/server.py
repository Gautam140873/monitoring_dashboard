...
@api_router.get("/audit/entity/{entity_type}/{entity_id}")
...
async def list_deleted_items(
    ...
    # Define collections that support soft delete
    ...
    for collection_name, id_field, name_field in soft_delete_collections:
        ...
        collection = db[collection_name]
        # Find items deleted within last 30 days
...
@api_router.post("/deleted/restore/{entity_type}/{entity_id}")
...
@api_router.post("/validate/duplicate")
